    ...
    public class CopyGroup : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                Reference reference = uiDoc.Selection.PickObject(ObjectType.Element, groupPickFilter, "Выбирете группу объектов");
                ...
                XYZ newRoomCentr = GetElementCenter(newRoom);
                XYZ newpoint = newRoomCentr - offset;
